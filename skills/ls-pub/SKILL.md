...
| [ReSpec-template](https://github.com/logius-standaarden/ReSpec-template) | Basis template voor nieuwe ReSpec documenten | [CC-BY-4.0](https://github.com/logius-standaarden/ReSpec-template/blob/develop/LICENSE) | [Lees online](https://logius-standaarden.github.io/ReSpec-template/) |
| [ReSpec-template-Logius](https://github.com/logius-standaarden/ReSpec-template-Logius) | Logius-specifiek ReSpec template met huisstijl | [CC-BY-4.0](https://github.com/logius-standaarden/ReSpec-template-Logius/blob/main/LICENSE) | [Lees online](https://logius-standaarden.github.io/ReSpec-template-Logius/) |
