...
| [OIN-Stelsel](https://github.com/logius-standaarden/OIN-Stelsel) | [v2.2.2](https://gitdocumentatie.logius.nl/publicatie/dk/oin/) | `2.2.0` | Publicatie teruggezet van v3.0.1 naar v2.2.2 (2026-09-15, publicatie-commit dc90a94). v3.0.0 en v3.0.1 blijven bereikbaar op hun eigen pad maar zijn niet meer de laatste versie (zie ook [ls-iam conflicts.md](../ls-iam/conflicts.md)) |
