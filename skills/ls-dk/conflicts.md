...
Geconstateerd: 2026-02-21 (OIN-Stelsel rij bijgewerkt 2026-09-17: v2.2.2)
...
| [Digikoppeling-Koppelvlakstandaard-REST-API](https://github.com/logius-standaarden/Digikoppeling-Koppelvlakstandaard-REST-API) | [v4.0.1](https://gitdocumentatie.logius.nl/publicatie/dk/restapi/) | `3.0.0` | Tag achter: publicatie v4.0.1 vs tag 3.0.0 |
...
| [Digikoppeling-Beveiligingsstandaarden-en-voorschriften](https://github.com/logius-standaarden/Digikoppeling-Beveiligingsstandaarden-en-voorschriften) | [v3.0.1](https://gitdocumentatie.logius.nl/publicatie/dk/beveilig/) | `2.0.0` | Tag achter: publicatie v3.0.1 vs tag 2.0.0 |
...
| [OIN-Stelsel](https://github.com/logius-standaarden/OIN-Stelsel) | [v2.2.2](https://gitdocumentatie.logius.nl/publicatie/dk/oin/) | `2.2.0` | De *latest*-verwijzing wees naar v3.0.1, een versie ter vaststelling (VV); op 2026-09-15 teruggezet naar de laatste vastgestelde versie v2.2.2 (publicatie-commit dc90a94). v3.0.0 en v3.0.1 blijven bereikbaar maar hebben `specStatus: VV`, dus zijn niet vastgesteld (zie ook [ls-iam conflicts.md](../ls-iam/conflicts.md)) |
...
| [Digikoppeling-Algemeen](https://github.com/logius-standaarden/Digikoppeling-Algemeen) | [v2026-2027](https://gitdocumentatie.logius.nl/publicatie/dk/roadmap/) | *(geen tags)* | Geen tags aanwezig; publicatie v2026-2027 (vastgesteld DEF, 2026-04-16) is niet getagd |
